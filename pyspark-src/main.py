...
spark_client = OLAPQueryEngine(
    parquet_paths={
        "people": "output_parquet_file.parquet",
...
# FROM
#     FCT_LINE_ITEM
# INNER JOIN DIM_DETAILED_ORDER ON L_ORDERKEY = O_ORDERKEY
# INNER JOIN DIM_DETAILED_PART ON L_PARTKEY = PS_PARTKEY AND L_SUPPKEY = PS_SUPPKEY
# WHERE
